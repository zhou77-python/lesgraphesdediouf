...
lire = pd.read_csv("data/transport-nodess.csv")
print(lire.shape)
print(lire.head(15))

lire1 = pd.read_csv("data/transport-relationships.csv")
print(lire1.shape)
print(lire1.head(15))
...
tooltip='voir plus' 
#group-data
group= os.path.join('data','group.json')
...
#choisir type de map 
#geojson 
folium.GeoJson(group).add_to(map_colony)
#select
